...
// зображень на підставі масиву даних. HTML містить 
// список ul.gallery.
...
// // Усі елементи галереї повинні додаватися в 
// DOM за одну операцію додавання.
// // Додай мінімальне оформлення 
...
const photo = images.map(({ url, alt }) => `
  <li>
    <img src="${url}" alt="${alt}">
  </li> 
`).join('');
